...
*/
class Ordenamiento extends Controller
{
///////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////
	function agregarProcedimiento()
	{
		...
		//---------------------------------------------------------------
		$d['frecuencia_lab']=$this->input->post('frecuencia_lab1');
		if($d['frecuencia_lab']=='0')
		{
			$d['id_frecuencia_lab'] = '0';
			$d['frecuencia_lab'] = '0';
		    $d['frecuencia']='ninguna';
			
			   
		}else{
			 $d['id_frecuencia_lab'] = $this->input->post('id_frecuencia_lab1');
		    	 
				if($d['id_frecuencia_lab']>0)
				{
				$d['frecuencia']= $this->urgencias_model->obtenerNomfrecuencia($d['id_frecuencia_lab']);
				}
			}
...
///////////////////////////////////////////////////////////////////
	function crearOrden_()
	{
		...
		/////////////////////////datos para capturar la periocidad para el laboratorio
		$d['periocidad_lab'] 	= $this->input->post('periocidad_lab_');
		$d['periocidad'] = $this->input->post('periocidad_');
...
///////////////////////////////////////////////////////////////////
	function agregarProcedimientoUrg()
	{
		...
		$d['id_tipo'] = $this->input->post('id_tipo');
		
		
		if($d['id_tipo']=='6')
		{
			    $d['cantidadCups'] = $this->input->post('cantidadCupsLab');
			    $d['id_frecuencia_lab'] = $this->input->post('id_frecuencia_lab');
				
		        $d['frecuencia_lab']=$this->input->post('frecuencia_lab');
