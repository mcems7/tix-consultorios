...
*/
class Hce_laboratorio extends Controller
{
///////////////////////////////////////////////////////////////////
...
*/
	function main($id_atencion)
	{
		...
		if($d['id_atencion']['id_servicio']==16 || $d['id_atencion']['id_servicio']==17 || $d['id_atencion']['id_servicio']==18 || $d['id_atencion']['id_servicio']==19){
...
*/
	...
	function OrdenInterpretar($id_ordenes,$registro_numero,$id_atencion)
	{
		...
		$d['resultadoAnalizador'] = $this -> ordenes_model -> OrdenInterpretarAnalizador($id_ordenes);
