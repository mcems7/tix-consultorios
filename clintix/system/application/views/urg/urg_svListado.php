<?php // echo $this->load->library("graph"); ?>
...
//////////
function grafica(id_nota)
{
	var var_url = '<?=site_url()?>/urg/sv_enfermeria/temperatura/'+id_nota;
	var ajax1 = new Request(
	{
		url: var_url,
		onRequest: function (){$('div_precarga').style.display = "block";},
		onSuccess: function(html){$('con_grafica').set('html', html);
		$('div_precarga').style.display = "none";},
		onComplete: function(){
		},
		evalScripts: true,
...
{
	var var_url = '<?=site_url()?>/urg/sv_enfermeria/crearNotaGases/'+id_nota;
	var ajax1 = new Request(
	{
		url: var_url,
		onRequest: function (){$('div_precarga').style.display = "block";},
...
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
function registroGlucometria(id_nota)
{
	var var_url = '<?=site_url()?>/urg/sv_enfermeria/crearNotaGlucometria/'+id_nota;
	var ajax1 = new Request(
	{
		url: var_url,
		onRequest: function (){$('div_precarga').style.display = "block";},
...
<tr>
  ...
  <tr>
  <td colspan="2" class="opcion"><a href="#sv_nota" onclick="registroGlucometria('<?=$atencion['id_atencion']?>')">Registrar Glucometria del Paciente</a></td>
