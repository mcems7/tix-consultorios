...
{
	if(!confirm("¿Esta seguro que desea verificar el ordenamiento?"))
	{
		return false;	
	}
	var var_url = '<?=site_url()?>/urg/evoluciones/evoConfirma';
...
<tr><td colspan="2" class="campo_centro">Verificación de la evolucion</td></tr>
  <tr>
