 ...
 var ph = $('ph').value;
  var paco2 = $('paco2').value;
		...
		if (sao2 == '')
	{
		...
		if (svo2 == '')
	{
		alert('debe ingresar un valor para sv02!!');
			return false;
	}
		if (lactato == '')
	{
		alert('debe ingresar un valor para lactato!!');
			return false;
	}
...
echo form_open('/hospi/hospi_sv_enfermeria/crearNotaGases_',$attributes);
...
<td><?=form_input(array('name' => 'lactato',
							'id'=> 'lactato',
							'maxlength' => '3',
							'size'=> '3',
							'autocomplete'=>'off',
