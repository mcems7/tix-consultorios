...
<h1 class="tituloppal">Central de autorizaciones - Anexo técnico No. 1</h1>
<h2 class="subtitulo">Informe de posibles inconsistencias en la base de datos de la entidad responsable de pago</h2>
<center>
<?php
$fecha = date('Y-m-d');
$hora = date('H:i');
...
echo form_open('/auto/main/anexo1_',$attributes);
...
<tr><td class="campo">Tipo de inconsistencia:</td><td colspan="3">
 
    <label>
      <input type="radio" name="tipo_inconsistencia" value="1" id="tipo_inconsistencia_0" />
      
      El usuario no existe en la base de datos</label><br />
  
    <label>
      <input type="radio" name="tipo_inconsistencia" value="2" id="tipo_inconsistencia_1" />
     Los datos del usuario no corresponden con los del documento de identificación presentados</label>
    </td></tr>
</table>
</td></tr>
