...
{
	var var_url = '<?=site_url()?>/admin/notas_trabajo_social/consultaNota/'+id_nota;
...
<h2 class="subtitulo">Notas de trabajo social</h2>
<center>
...
<tr>
<td colspan="2" class="opcion"><a href="<?=site_url()?>/admin/notas_trabajo_social/crearNota/<?=$atencion['id_atencion']?>">Crear una nota de trabajo social</a></td></tr>
<tr><td colspan="2">&nbsp;</td></tr>
<tr><th colspan="2">Notas de trabajo social realizadas</th></tr>
<tr>
<td>
<div id="con_nota">
...
<?php
	if($notas == 0)
	{
		echo "<center><strong>No se ha registrado ninguna nota</strong></center>";	
	}else{
?>
<table width="100%" border="0" cellspacing="2" cellpadding="2" class="tabla_interna">
<tr>
    ...
    <td class="campo_centro">Funcionario</td>
