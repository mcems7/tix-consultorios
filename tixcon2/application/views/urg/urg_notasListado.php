...
{
	var var_url = '<?=site_url()?>/urg/notas_enfermeria/consultaNota/'+id_nota;
...
<tr>
  <td colspan="2" class="opcion"><a href="<?=site_url()?>/urg/notas_enfermeria/crearNota/<?=$atencion['id_atencion']?>">Registrar una nota de enfermer&iacute;a en blanco</a></td></tr>
<?php
	if($notas != 0)
	{
?>  
<tr>
  <td colspan="2" class="opcion"><a href="<?=site_url()?>/urg/notas_enfermeria/crearNotaEdit/<?=$atencion['id_atencion']?>">Registrar una nota de enfermer&iacute;a con base en última registrada</a></td></tr>
<?php
	}
?>
