...
<h2 class="subtitulo">Ordenamiento de Insumos y Dispositivos médicos</h2>
<center>
...
<tr><td colspan="2" class="opcion"><a href="<?=site_url()?>/urg/insumos/crearOrdenInsumoIndepe/<?=$atencion['id_atencion']?>">Registrar una orden de insumos</a></td></tr>
...
<tr>
    ...
    <td class="campo_centro">Alaboro</td>
...
?>
  <tr>
<td class="campo_centro"><?=$d['id_orden_insumos'];?></td>
<td><?=$d['fecha_creacion'];?></td>
<td><?=$d['primer_apellido']." ".$d['segundo_apellido']." ".$d['primer_nombre']." ".$d['segundo_nombre']?></td>
<td class="opcion"><a href="<?=site_url('urg/insumos/consultarOrden/'.$d['id_orden_insumos'])?>"><strong>Consultar</strong></a></td>
</tr>
<?php
}
?>
