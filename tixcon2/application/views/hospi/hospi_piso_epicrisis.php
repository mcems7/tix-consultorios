<link rel="stylesheet" href="http://172.16.50.100/yage_sanpio/resources/styles/general.css" type="text/css" media="screen" />
...
{
	var var_url = '<?=site_url()?>/hospi/hospi_gestion_atencion/consultaEvolucion/'+id_evo;
...
echo form_open('/hospi/hospi_gestion_atencion/epicrisis_',$attributes);
