...
<h1 class="tituloppal">Servicio de hospitalizaci&oacute;n - M&oacute;dulo de Enfermer&iacute;a</h1>
...
<tr>
  <td colspan="2" class="opcion"><a href="<?=site_url()?>/hospi/hospi_notas_enfermeria/crearNota/<?=$atencion['id_atencion']?>">Registrar una nota de enfermer&iacute;a en blanco</a></td></tr>
<?php
	if($notas != 0)
	{
?>  
<tr>
  <td colspan="2" class="opcion"><a href="<?=site_url()?>/hospi/hospi_notas_enfermeria/crearNotaEdit/<?=$atencion['id_atencion']?>">Registrar una nota de enfermer&iacute;a con base en última registrada</a></td></tr>
<?php
	}
?>
