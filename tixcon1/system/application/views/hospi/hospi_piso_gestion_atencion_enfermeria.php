...
<h1 class="tituloppal">Unidad de hospitalizaci&oacute;n enfermeria</h1>
...
<tr>
<td class="opcion">
<?=anchor('hospi/hospi_enfermeria/consultaNotaInicial/'.$atencion['id_atencion'], 'Consultar Nota inicial', 'title="Consultar Nota inicial"');?>
</td>

<td class="opcion">
<?=anchor('hospi/hospi_enfermeria/ordenamiento/'.$atencion['id_atencion'], '&Oacute;rdenes m&eacute;dicas', 'title="&Oacute;rdenes m&eacute;dicas"');?>
</td>
<td class="opcion">
<?=anchor('/hospi/hospi_notas_enfermeria/main/'.$atencion['id_atencion'],'Notas de enfermer&iacute;a','title="Notas de enfermer&iacute;a"');?>
</td>
</tr><tr>
...
<td class="opcion">
<?=anchor('/hospi/hospi_sv_enfermeria/main/'.$atencion['id_atencion'],'Signos Vitales enfermer&iacute;a','title="Signos Vitales enfermer&iacute;a"');?>
</td>
<td class="opcion">
<?=anchor('/hospi/hospi_bl_enfermeria/main/'.$atencion['id_atencion'],'Balance De L&iacute;quidos','title="Balance De L&iacute;quidos"');?>
</td>
</tr>
</table>
</td>
