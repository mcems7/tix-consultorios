...
function agregarInsumo()
{
	...
	var var_url = '<?=site_url()?>/hospi/hospi_insumos/agregarInsumo';
...
////////////////////////////////////////////////////////////////////////////////
function actualizarCupsPagador(tipo,id,pagador)
{
	var var_url = '<?=site_url()?>/hospi/hospi_insumos/asignarPagadorCups/'+tipo+'/'+id+'/'+pagador;
	var ajax1 = new Request(
	{
		url: var_url,
		onRequest: function (){$('div_precarga').style.display = "block";},
...
<h2 class="subtitulo">Solicitud de insumos - Consultar orden médica</h2>
<center>
<?php
...
echo form_open('/hospi/hospi_insumos/crearOrdenInsumos_',$attributes);
...
<?php
  foreach($ordenMedi as $d)
  {
    ...
    echo $this->load->view('hospi/hospi_piso_insu_con_medicamento',$d);
  }
?>  
  </td></tr> 
<?php
...
<tr>
  ...
  <?=$this->load->view('hospi/hospi_piso_insu_agregar', $d)?>
  </td></tr>
<?php
...
<?php
  foreach($ordenCupsLab as $d)
  {
    ...
    echo $this->load->view('hospi/hospi_piso_insu_con_cups',$d);
  }
?> 
  </td></tr>
<?php
