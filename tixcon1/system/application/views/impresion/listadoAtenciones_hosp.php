...
<br />
<?php
if(!is_null($listaHosp))
{
?>
<table style="width:100%" class="tabla_form">
<tr><th colspan="5" class="campo_centro">Atenciones vigentes Hospitalización</th></tr>
<tr>
<td class="campo_centro">No.</td>
<td class="campo_centro">Fecha de ingreso</td>
<td class="campo_centro">Fecha de egreso</td>
...
<?php
	...
	foreach($listaHosp as $d1)
	{
?>
<tr>
<td align="center"><strong><?=$i?></strong></td>
<td><?=$d1['fecha_ingreso']?></td>
<td><?=$d1['fecha_egreso']?></td>
<td><?=$d1['nombre_servicio']?></td>
<td class="opcion"><a href="javascript:Abrir_ventana('<?=site_url('impresion/impresion/atencionHosp/'.$d1['id_atencion'])?>')"><strong>Imprimir</strong></a></td>
</tr>
<?php
$i++;
	}
...
<table>
<tr>
<td colspan="5" class="campo_centro">No se encontraron registros de atenciones en hospitalizaci&oacute;n</td>
</tr>
</table>
<?php
}
