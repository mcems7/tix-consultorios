...
function capituloSec()
{
	...
	var var_url = '<?=site_url()?>/util/cups/cupsCaps/'+sec;
...
function gruposCap()
{
	...
	var var_url = '<?=site_url()?>/util/cups/cupsGrupos/'+cap;
	var ajax1 = new Request(
	{
		url: var_url,
		method: 'post',
...
function subGGru()
{
	...
	var var_url = '<?=site_url()?>/util/cups/cupsSubGrupos/'+gru;
	var ajax1 = new Request(
	{
		url: var_url,
		method: 'post',
...
function CubGcate()
{
	...
	var var_url = '<?=site_url()?>/util/cups/cupsCategorias/'+sgru;
	var ajax1 = new Request(
	{
		url: var_url,
		method: 'post',
...
function CubCaSubca()
{
	...
	var var_url = '<?=site_url()?>/util/cups/cupsSubCate/'+cate;
	var ajax1 = new Request(
	{
		url: var_url,
		method: 'post',
