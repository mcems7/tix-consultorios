...
$attributes = array('id'       => 'formulario',
	...
	echo form_open('/coam/coam_admision/editar_admision_',$attributes);
...
<h2 class="subtitulo">Editar la admisión de un paciente</h2>
<center>
...
<td>
<select name="id_entidad" id="id_entidad" style="font-size:9px" onchange="obtenerContratosEntidadEditar('<?=$atencion['id_atencion']?>')">
...
obtenerContratosEntidadEditar('<?=$atencion['id_atencion']?>');
</script>
</td></tr>
...
<?=$this->load->view('coam/coam_adm_general_editar')?>
<tr><td colspan="2" class="linea_azul">&nbsp;</td></tr>
