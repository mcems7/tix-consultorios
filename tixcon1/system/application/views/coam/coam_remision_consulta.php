...
<h2 class="subtitulo">Consulta remisión de un paciente</h2>
<center>
...
<tr>
<td class="campo">Fecha y hora remisi&oacute;n:</td>
...
$data = array(	'name' => 'imp',
				'onclick' => "Abrir_ventana('".site_url('impresion/coam/remision/'.$remision['id_remision'])."')",
				'value' => 'Imprimir',
				'type' =>'button');
