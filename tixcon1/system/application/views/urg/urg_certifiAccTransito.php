...
<h2 class="subtitulo">Certificado de atención médica para víctimas de accidentes de transito</h2>
<center>
...
$data = array(	'name' => 'imp',
				'onclick' => "Abrir_ventana('".site_url('impresion/impresion/certificadoAccTransito/'.$atencion['id_atencion'])."')",
				'value' => 'Imprimir',
				'type' =>'button');
