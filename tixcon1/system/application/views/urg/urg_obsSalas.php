...
function ingresoObservacion(id_obs)
{
	...
	{
		var div = 'cama'+id_obs;
		var var_url = '<?=site_url()?>/urg/observacion/ingresoObservacion/'+id_obs;
...
function asignarCama(id_obs)
{
	...
	var div = 'cama'+id_obs;
	var var_url = '<?=site_url()?>/urg/observacion/ingresoObservacionCama/'+id_obs+'/'+cama;
	var ajax1 = new Request(
	{
		url: var_url,
		onSuccess: function(html){$(div).set('html', html);},
...
function obtenerSala()
{
	...
	var var_url = '<?=site_url()?>/urg/observacion/listadoPacientesSala';
	var ajax1 = new Request(
	{
		url: var_url,
		method: 'post',
...
function activarCama(id_cama)
{
	...
	var var_url = '<?=site_url()?>/urg/observacion/activarCama/'+id_cama;
	var ajax1 = new Request(
	{
		url: var_url,
		method: 'post',
