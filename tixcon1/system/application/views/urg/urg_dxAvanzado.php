...
function capituloDx()
{
	...
	var var_url = '<?=site_url()?>/urg/atencion_inicial/dxCaps/'+cap;
...
function nivel1Dx()
{
	...
	var var_url = '<?=site_url()?>/urg/atencion_inicial/dxNivel1/'+nivel1s;
	var ajax1 = new Request(
	{
		url: var_url,
		method: 'post',
...
function nivel2Dx()
{
	...
	var var_url = '<?=site_url()?>/urg/atencion_inicial/dxNivel2/'+nivel2s;
	var ajax1 = new Request(
	{
		url: var_url,
		method: 'post',
