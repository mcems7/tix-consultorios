...
<?php
	...
	{
?>
<a href="<?=site_url()?>/hospi/hospi_ordenamiento/crearOrdenEdit/<?=$atencion['id_atencion']?>">Registrar una orden médica</a>
<?php
	}else{
?>
<a href="<?=site_url()?>/hospi/hospi_ordenamiento/crearOrden/<?=$atencion['id_atencion']?>">Registrar una orden médica</a>
<?php
	}
?>
</td></tr>
...
<td class="opcion"><a href="<?=site_url('hospi/hospi_ordenamiento/consultarOrden/'.$d['id_orden'])?>"><strong>Consultar</strong></a></td>
</tr>
<?php
	}
?>
