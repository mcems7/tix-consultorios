...
echo form_open('/hosp/hosp_gestion_atencion/registrarAtencionEdit_',$attributes);
...
<?=form_input(array('name' => 'fecha_ing',
						'id'=> 'fecha_ing',
						'maxlength' => '10',
						'value' => $atencion['fecha_ingreso'],
						'class'=> "fValidate['required']",
						'size'=> '16'))?>(aaaa-mm-dd HH:mm)
</td></tr>
...
<?
	foreach($origen as $d)
	{
		if($atencion['id_origen'] == $d['id_origen']){
