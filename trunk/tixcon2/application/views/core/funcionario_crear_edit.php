...
{
	var var_url = '<?=site_url()?>/core/administrar_funcionario/verificarUsuario';
	var ajax1 = new Request(
	{
		url: var_url,
		method: 'post',
...
$attributes = array('id'       => 'formulario',
	...
	echo form_open('/core/administrar_funcionario/crearFuncionarioEdit_',$attributes);
	echo form_hidden('id_tercero',$tercero['id_tercero']);
?>
<h1 class="tituloppal">Administración del sistema</h1>
<h2 class="subtitulo">Crear un nuevo funcionario</h2>
<center>
...
?>
  ...
  <tr>
   ...
   <tr>
	...
	?>
    Urbana&nbsp;<input name="zona" id="zona" type="radio" value="Urbana" <?=$res1?> />
    Rural&nbsp;<input name="zona" id="zona" type="radio" value="Rural" <?=$res2?>/>
    </td>
  </tr>
   <tr>
