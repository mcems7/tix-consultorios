...
echo form_open('/core/administrar_proveedores/buscarProveedor',$attributes);
?>
<h1 class="tituloppal">Administración del sistema</h1>
<h2 class="subtitulo">Administración de proveedores</h2>
<center>
...
<tr>
  <td colspan="2" class="opcion">
    <a href="<?=site_url('core/administrar_proveedores/crearProveedor')?>">Registrar un proveedor</a></td></tr>
<tr><td colspan="2">

<table width="100%" class="tabla_interna">
<tr>
  <th colspan="5">Listado de proveedores</th></tr>
<tr>
...
<td><?=$d['estado']?></td>
<td class="opcion"><a href="<?=site_url('core/administrar_proveedores/editarProveedor/'.$d['id_proveedor'])?>">Editar</a></td>
</tr>
<?php
	}
?>
