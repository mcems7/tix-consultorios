...
class Administrar_cama extends Administrar_entidad_generica
{
	...
	protected function _obtenerEspecificacion()
	{
		...
		$spec['campos'][3]['etiqueta']      = 'Tipo Cama';
		$spec['campos'][3]['tipo']          = 'consulta';
		$spec['campos'][3]['origen_tabla']  = 'core_camas_tipo';
		$spec['campos'][3]['origen_codigo'] = 'id_cama_tipo';
		$spec['campos'][3]['origen_valor']  = 'descripcion';
		$spec['campos'][3]['campo_nombre']  = 'id_cama_tipo';		
		
		$spec['campos'][4]['etiqueta']      = 'Estado';
		$spec['campos'][4]['tipo']          = 'consulta';
		$spec['campos'][4]['origen_tabla']  = 'core_estados_camas';
		$spec['campos'][4]['origen_codigo'] = 'id_estado';
		$spec['campos'][4]['origen_valor']  = 'estado';
		$spec['campos'][4]['campo_nombre']  = 'id_estado';		
