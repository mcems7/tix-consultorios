...
function filtrar()
{
    ...
    var var_url = '<?=site_url()?>/citas/autorizar_cita/lista_autorizacion/'+$('id_especialidad').value+'/'+id_departamento+'/'+id_municipio+'/'+$('tipo_atencion').value+'/'+$('prioritaria').value+'/'+$('id_entidad_remitente').value;
    var ajax1 = new Request(
	{       
		url: var_url,
                async: false,
...
<td id="nombre_municipio">
                ...
                <tr>
                    <td class='campo_izquierda'>Causa de atención:</td>
                ...
                <tr>
                    <td class='campo_izquierda'>Prioritaria</td>
                     ...
                     <tr>   <td class='campo_izquierda'>Institución</td>
                        <td>
                           <select name="id_entidad_remitente" id="id_entidad_remitente">
