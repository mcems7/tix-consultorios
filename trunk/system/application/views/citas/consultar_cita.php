...
function dato()
{
	...
	if(id_tipo_doc == 0 && primer_apellido == 0 && segundo_apellido == 0 && primer_nombre == 0 && segundo_nombre == 0 && pin == 0)
...
function buscar()
{
       var var_url = '<?=site_url()?>/citas/estado_cita/buscar';
...
<td width="50%"><?=form_input(array('name' => 'pin',
							'id'=> 'pin',
							'maxlength'   => '20',
							'size'=> '20',
							))?>
</td></tr>
<tr><td width="50%" class="campo_izquierda">Número de documento del paciente:</td>
...
<tr>
    <td width="50%" class="campo_izquierda">Primer apellido:</td>
   ...
   <tr>
    <td class="campo_izquierda">Segundo apellido:</td>
  ...
  <tr>
    <td class="campo_izquierda">Primer nombre:</td>
   ...
   <tr>
    <td class="campo_izquierda">Segundo nombre:</td>
