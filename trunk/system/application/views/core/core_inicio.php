...
<table width="<?=$tama?>" class="tabla_principal" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <img  src="<?=base_url()?>resources/img/baneryage.jpg"/>
    </td>
  </tr>
   <?php
