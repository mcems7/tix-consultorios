...
//
///////////////////////////////////////////////////////////////////////////////
function ingresar_remision($variables_post_remision,$id_tercero,$variables_tercero)
{
    $this->db->insert('cita_remisiones',$variables_post_remision);
...
{
    $query="select ct.`primer_apellido`, ct.`segundo_apellido`,
            ...
            inner join `core_eapb` cea on cr.`id_entidad_remitente`=cea.`codigo_eapb`
inner join `core_especialidad` ce on ce.`id_especialidad`=cr.`id_especialidad` 
inner join `core_tercero` cer on cea.`id_tercero` =cer.`id_tercero` 
...
///////////////////////////////////////////////////////////////////////////////
    function actualizar_remision($variables_post)
    {
        ...
        $this->db->update('cita_remisiones',$variables_post);
    }
///////////////////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////////////////    
 ...
 from `agenda_dia_detalle` agd
 	  inner join `agenda_agenda_dia_consultorio` agdc on agd.`id_agenda_consultorio`= agdc.`id_agenda_consultorio`
      inner join agenda_agenda_dia aad on aad.`id_agenda_dia`=agdc.`id_agenda_dia`
...
{
$query="select IFNULL(sum(duracion),0) duracion FROM  `citas_asignadas_agenda` a
...
//
///////////////////////////////////////////////////////////////////////////////
    function dar_baja_cita($id_cita,$id_usuario)
    {
        $this->db->WHERE('id_remision',$id_cita);
        $this->db->DELETE('citas_asignadas_agenda');
        $insert=array('id_cita'=>$id_cita,
...
//
///////////////////////////////////////////////////////////////////////////////
    function confirmar_cita($id_cita,$id_usuario)
    {
        $insert=array('id_cita'=>$id_cita,
                      'id_usuario'=>$id_usuario,
...
{
    $this->db->SELECT('ce.codigo_eapb codigo_entidad, ct.razon_social nombre');
...
private function base_consulta_cita()
{
    ...
    $this->db->JOIN('citas_asignadas_agenda caa','cr.id=caa.id_remision','left');
    $this->db->JOIN('agenda_dia_detalle agdd','agdd.id_agenda_dia_detalle=caa.id_agenda_dia_detalle','left');
    $this->db->JOIN('agenda_agenda_dia_consultorio aadc','aadc.id_agenda_consultorio=agdd.id_agenda_consultorio','left');
    $this->db->JOIN('agenda_agenda_dia aad','aadc.id_agenda_dia=aad.id_agenda_dia','left');
    $this->db->JOIN('agenda_consultorios` ac','aadc.id_consultorio=ac.id_consultorio','left');
