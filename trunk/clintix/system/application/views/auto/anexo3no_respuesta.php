...
<p>Dando cumplimiento a lo establecido en el artículo número 4 de la resolución 3047 de 2008, se procede a notificar a la dirección de salud territorial, la no respuesta a la solicitud de autorización en los términos establecidos y se indica que se han efectuado 3 envíos de  la solicitud de autorización de servicios posteriores a la atención inicial de urgencias.</p>
 <table width="100%">
  <tr>
    <th colspan="2">Detalle env&iacute;os&nbsp;</th>
  </tr>
  <tr>
    <td style="text-align:center; font-weight:bold">Fecha y hora</td>
    <td style="text-align:center; font-weight:bold">N&uacute;mero env&iacute;o</td>
  </tr>
<?php
	foreach($envios as $d)
	{
