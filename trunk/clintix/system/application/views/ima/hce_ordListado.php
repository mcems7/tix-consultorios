...
<?php
	if($ordenes == 0)
	{
		echo "<center><strong>No se ha generado ningun resultado de imagenes diagnosticas</strong></center>";	
	}else{
?>
<table width="100%" border="0" cellspacing="2" cellpadding="2" class="tabla_interna">
<tr>
...
<td class="opcion"><a href="<?=site_url('ima/hce_imagenes/OrdenConsultar/'.$d['id'].'/'.$atencion['id_atencion'])?>"><strong>Ver</strong></a></td>
</tr> 
<?php
	}
		echo "</table>";
