...
{
    var var_url = '<?=site_url()?>/rips/rips_editar/rips_medico/'+$('fecha_agenda_inicial').value+'/'+$('fecha_agenda').value+'/'+$('id_especialista').value
    var ajax1 = new Request(
	{
		url: var_url,
		method: 'post',
...
function editar(id_atencion)
{
   ...
   var var_url = '<?=site_url()?>/rips/rips_editar/rips_factura_editar/'+$('fecha_agenda_inicial').value+'/'+$('fecha_agenda').value+'/'+$('id_especialista').value+'/'+id_atencion+'/'+factura
    var ajax1 = new Request(
	{
		url: var_url,
		method: 'post',
