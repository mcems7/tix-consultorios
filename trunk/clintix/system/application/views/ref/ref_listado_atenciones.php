...
<td class="opcion"><a href="<?=site_url('ref/traslados/crear_traslado/'.$d['id_atencion'].'/urg')?>"><strong>Crear traslado</strong></a></td></tr>
<?php
$i++;
	}
?>
...
<td><?=$d['fecha_ingreso']?></td>
<td><?=$d['nombre_servicio']?></td>
<td class="opcion"><a href="<?=site_url('ref/traslados/crear_traslado/'.$d['id_atencion'].'/hosp')?>"><strong>Crear traslado</strong></a></td></tr>
