...
function obtenerPiso()
{
	...
	var var_url = '<?=site_url()?>/hospi/hospi_gestion_atencion/listadoPacientesPiso';
...
<option value="10">UCI Adultos</option>
<?php
/*

Comentado para darle acceso solo al servicio de UCI
