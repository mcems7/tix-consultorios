...
{
	var var_url = '<?=site_url()?>/hospi/hospi_evoluciones/consultaEvolucion/'+id_evo;
...
<h2 class="subtitulo">Gesti&oacute;n de evoluciones</h2>
<center>
...
<tr>
  <td colspan="2" class="opcion"><a href="<?=site_url()?>/hospi/hospi_evoluciones/crearEvolucion/<?=$atencion['id_atencion']?>">Registrar una evolución en blanco</a></td></tr>
<?php
if($evo != 0)
{
?>  
<tr>
  <td colspan="2" class="opcion"><a href="<?=site_url()?>/hospi/hospi_evoluciones/crearEvolucionEdit/<?=$atencion['id_atencion']?>">Registrar una evolución con base en última registrada</a></td></tr>
<?php
}
?>
