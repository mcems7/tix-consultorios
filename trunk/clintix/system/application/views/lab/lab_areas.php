...
function quimica()
{
  ...
  var var_url = '<?=site_url()?>/lab/laboratorio/OrdenesQuimica'
  var ajax1 = new Request(
  {
    url: var_url,
    method: 'post',
    ...
    onRequest: function (){$('div_precarga').style.display = "block";},
    onSuccess: function(html){$('div_quimica').set('html', html);
    $('div_precarga').style.display = "none";},
    onComplete: function(){},
    evalScripts: true,
    onFailure: function(){alert('Error ejecutando ajax!');}
...
////////////////////////////////////////////////////////////////////////////////
function microbiologia()
{
  
  var var_url = '<?=site_url()?>/lab/laboratorio/OrdenesMicrobiologia'
  var ajax1 = new Request(
  {
    url: var_url,
    method: 'post',
    ...
    onRequest: function (){$('div_precarga').style.display = "block";},
    onSuccess: function(html){$('div_microbiologia').set('html', html);
    $('div_precarga').style.display = "none";},
    onComplete: function(){},
    evalScripts: true,
    onFailure: function(){alert('Error ejecutando ajax!');}
...
function uroanalisis()
{
  ...
  var var_url = '<?=site_url()?>/lab/laboratorio/OrdenesUroanalisis'
  var ajax1 = new Request(
  {
    url: var_url,
    method: 'post',
    data:  $('formulario4').toQueryString(),
    onRequest: function (){$('div_precarga').style.display = "block";},
    onSuccess: function(html){$('div_uroanalisis').set('html', html);
    $('div_precarga').style.display = "none";},
    onComplete: function(){},
    evalScripts: true,
    onFailure: function(){alert('Error ejecutando ajax!');}
...
////////////////////////////////////////////////////////////////////////////////
function inmunologia()
{
  
  var var_url = '<?=site_url()?>/lab/laboratorio/OrdenesInmunologia'
  var ajax1 = new Request(
  {
    url: var_url,
    method: 'post',
    data:  $('formulario5').toQueryString(),
    onRequest: function (){$('div_precarga').style.display = "block";},
    onSuccess: function(html){$('div_inmunologia').set('html', html);
    $('div_precarga').style.display = "none";},
    onComplete: function(){},
    evalScripts: true,
    onFailure: function(){alert('Error ejecutando ajax!');}
...
function coagulacion()
{
  ...
  var var_url = '<?=site_url()?>/lab/laboratorio/OrdenesCoagulacion'
  var ajax1 = new Request(
  {
    url: var_url,
    method: 'post',
    data:  $('formulario6').toQueryString(),
    onRequest: function (){$('div_precarga').style.display = "block";},
    onSuccess: function(html){$('div_coagulacion').set('html', html);
    $('div_precarga').style.display = "none";},
    onComplete: function(){},
    evalScripts: true,
    onFailure: function(){alert('Error ejecutando ajax!');}
...
function serologia()
{
  ...
  var var_url = '<?=site_url()?>/lab/laboratorio/OrdenesSerologia'
  var ajax1 = new Request(
  {
    url: var_url,
    method: 'post',
    data:  $('formulario7').toQueryString(),
    onRequest: function (){$('div_precarga').style.display = "block";},
    onSuccess: function(html){$('div_serologia').set('html', html);
    $('div_precarga').style.display = "none";},
    onComplete: function(){},
    evalScripts: true,
    onFailure: function(){alert('Error ejecutando ajax!');}
...
<?php
$id = $this->session->userdata('id_arealab');
$res0 = '';
$res1 = '';
$res2 = '';
$res3 = '';
...
<select name="id_modulo" id="id_modulo" onchange="obtenerModulo()">
  <option value="0" <?=$res0?>>-Todas-</option>
  <option value="1" <?=$res1?>>Hematologia</option>
  <option value="2" <?=$res2?>>Quimica</option>
  <option value="3" <?=$res3?>>Microbiologia</option>
  <option value="4" <?=$res4?>>Uroanalisis</option>
  <option value="5" <?=$res5?>>Inmunologia</option>
  <option value="6" <?=$res6?>>Coagulacion</option>
  <option value="7" <?=$res7?>>Serologia</option>
