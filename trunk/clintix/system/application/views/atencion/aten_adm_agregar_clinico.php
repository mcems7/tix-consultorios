...
function clinico_tipo_num(){
	 ...
	 var var_url = '<?=site_url()?>/atencion/aten_adm_hc/AgregarClinicoNum'
...
function clinico_tipo_texto(){
	 ...
	 var var_url = '<?=site_url()?>/atencion/aten_adm_hc/AgregarClinicoText'
  var ajax1 = new Request(
  {
    url: var_url,
...
function clinico_tipo_lista(identificador){
	 ...
	 var var_url = '<?=site_url()?>/atencion/aten_adm_hc/AgregarClinicoList/'+identificador
  var ajax1 = new Request(
  {
    url: var_url,
...
$attributes = array('id'       => 'formulario',
	                'name'     => 'formulario',
					'method'   => 'post');
echo form_open('/atencion/aten_adm_hc/Ingresa_Clinico',$attributes);
