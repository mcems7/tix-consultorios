...
///////////////////////////////////////////////////////////////////
	function pruebas ()
	{
		$sql = "SELECT core_tercero.id_tercero
FROM `core_tercero`
WHERE `primer_apellido` != 'URGENCIAS'
AND `razon_social` = '' ORDER BY core_tercero.id_tercero desc
";
  ...
  foreach($result  as $d)
  {
	$sql2 = "UPDATE core_tercero SET 
	primer_nombre = 'PACIENTE',
	segundo_nombre = '',
	primer_apellido = 'URGENCIAS',
	segundo_apellido = ''  
	WHERE id_tercero = '".$d['id_tercero']."';";  
	 $this->db->query($sql2);
	 $i++;
  }
  echo $i;
