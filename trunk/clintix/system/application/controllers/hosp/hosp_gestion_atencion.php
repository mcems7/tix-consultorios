...
*/
class Hosp_gestion_atencion extends Controller
{
///////////////////////////////////////////////////////////////////
...
///////////////////////////////////////////////////////////////////
function cambio_entidad($id_atencion)
{
	//----------------------------------------------------------
	$d = array();
	$d['urlRegresar'] 	= site_url('hosp/hosp_gestion_atencion/main/'.$id_atencion);
	//----------------------------------------------------------
	$d['entidades'] = $this -> paciente_model -> obtenerEntidades();
	...
	//-----------------------------------------------------------
	$this->load->view('core/core_inicio');
	$this -> load -> view('hosp/hosp_registro_atencion_cambio_entidad', $d);
	$this->load->view('core/core_fin');
	//----------------------------------------------------------
}
///////////////////////////////////////////////////////////////////
function cambio_entidad_()
{
	//----------------------------------------------------------
	$d = array();
	//----------------------------------------------------------
	...
	$d['id_entidad'] 	= $this->input->post('id_entidad');
	//----------------------------------------------------------
	$this->hosp_model->cambiar_entidadDb($d);
	//----------------------------------------------------------
	$dt['mensaje']  = "El cambio se ha realizado satisfactoriamente!!";
	$dt['urlRegresar'] = site_url('hosp/hosp_gestion_atencion/main/'.$d['id_atencion']);
	$this -> load -> view('core/presentacionMensaje', $dt);
	return;	
	//----------------------------------------------------------
}
