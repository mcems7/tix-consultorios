...
<?=anchor('coam/coam_ordenamiento/crearOrden/'.$atencion['id_atencion'], 'Registrar una orden m&eacute;dica', 'title="Registrar una orden m&eacute;dica"');?>
</td></tr>
...
<td><?=$d['esp'];?></td>
<td class="opcion"><a href="<?=site_url('coam/coam_ordenamiento/consultarOrden/'.$d['id_orden'])?>"><strong>Consultar</strong></a></td>
</tr>
<?php
	}
?>
