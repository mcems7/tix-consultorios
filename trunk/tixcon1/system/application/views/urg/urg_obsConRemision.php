...
<td><?php
echo $remision['incapacidad'];
if($remision['incapacidad'] == 'SI')
	echo nbs(),$remision['incapacidad'], nbs(),'D&iacute;as';
?></td></tr>

<tr>
  <th colspan="2">Resumen de anamnesís y examen fisico.</th></tr>
<td colspan="2"><?=$remision['resumen_anamnesis']?></td></tr>
<tr>
  <th colspan="2">Exámenes auxiliares de diagnósticos solicitados</th></tr>
<td colspan="2"><?=$remision['examenes_auxiliares']?></td></tr>
...
<td colspan="2"><?=$remision['complicaciones']?></td></tr>
...
<td colspan="2"><?=$remision['motivo_remision']?></td></tr>
