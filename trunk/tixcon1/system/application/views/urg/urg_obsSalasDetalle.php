...
<td class="campo_centro">Evoluciones</td>
<td class="campo_centro">Fecha y hora última evolución</td>
</tr>
<?php
	$i = 1;
	foreach($lista as $d)
...
<td align="center">
<?php
	echo $this->urgencias_model->numeroEvolucionesObservacion($d['id_atencion'],$d['id_servicio']);
?>
</td>
<td class="campo_centro">Evoluciones</td>
</tr>	
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="tabla_cama">
  ...
  <td width="60px" rowspan="2"><?php if ($lab>0){
        ...
        <img src="<?=base_url()?>resources/images/iconos/<?=$d['icono']?>"/>
        <?php } ?></td>
  </tr><tr><td>
