...
<td class="opcion">
<a href="<?=site_url()?>/urg/observacion/epicrisis/<?=$atencion['id_atencion']?>">Egreso del servicio Epicrisis</a>
</td>
</tr>
<tr>
<tr><td class="opcion">
<a href="<?=site_url()?>/admin/notas_trabajo_social/main/<?=$atencion['id_atencion']?>">Notas de trabajo social</a></td>
<td class="opcion">
<a href="<?=site_url()?>/admin/main/notas_administrativas/<?=$atencion['id_atencion']?>">Notas administrativas</a></td>
<td class="opcion"> 
<a href="<?=site_url()?>/admin/main/pendientes/<?=$atencion['id_atencion']?>">Pendientes</a>
</td>
</tr>
</table>
</td>
