...
{
	var var_url = '<?=site_url()?>/hospi/hospi_bl_enfermeria/consultaBalance/'+id_atencion+'/'+fecha_nota;
...
{
	var var_url = '<?=site_url()?>/hospi/hospi_bl_enfermeria/crearNotaAdm/'+id_nota;
	var ajax1 = new Request(
	{
		url: var_url,
		onRequest: function (){$('div_precarga').style.display = "block";},
...
{
	var var_url = '<?=site_url()?>/hospi/hospi_bl_enfermeria/crearNotaEli/'+id_nota;
	var ajax1 = new Request(
	{
		url: var_url,
		onRequest: function (){$('div_precarga').style.display = "block";},
...
<h2 class="subtitulo">Balance de l&iacute;quidos - Enfermer&iacute;a</h2>
<center>
...
<tr>
  <td colspan="2" class="opcion"><a href="#bl_nota" onclick="registroadministrados('<?=$atencion['id_atencion']?>')">Registrar Líquidos Administrados</a></td>
</tr>
<tr>
  <td colspan="2" class="opcion"><a href="#bl_nota" onclick="registroeliminados('<?=$atencion['id_atencion']?>')">Registrar Líquidos Eliminados</a></td>
