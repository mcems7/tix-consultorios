...
//////////////////////////////////////////////////////////////////////////////////
	...
	$this->db->FROM('agenda_consultorios');
	...
	$this->db->FROM('core_especialidad ce ');
        $this->db->join('agenda_consultorios_especialidades ace','ace.id_especialidad=ce.id_especialidad');
        $this->db->join('agenda_consultorios ac','ace.id_consultorio=ac.id_consultorio');
    ...
    { 
        ...
        $this->db->update('agenda_consultorios',$update);          
    }
    ...
    { 
        ...
        $this->db->update('agenda_consultorios_especialidades',$update);          
    }
    ...
    function agregar_consultorio($nombre_consultorio)
    {
     ...
     $this ->db->insert('agenda_consultorios',$d);
    }
    ...
    function lista_especialidades_consultorios()
    {
        ...
        $this->db->FROM('core_especialidad ce'); 
        $this->db->distinct();
        $this->db->JOIN('agenda_consultorios_especialidades  ace','ce.id_especialidad=ace.id_especialidad');
        return $this->db->get()->result_array();
    }
    function lista_consultorios_especialidad($id_especialidad)
    {
        $this->db->SELECT('ac.id_consultorio, ac.descripcion');
        $this->db->FROM('agenda_consultorios` ac'); 
        $this->db->JOIN('agenda_consultorios_especialidades  ace','ac.id_consultorio=ace.id_consultorio');
    ...
    function agregar_especialidad_consultorio($id_consultorio, $id_especialidad)
    {
     ...
     $this ->db->insert('agenda_consultorios_especialidades',$d);
    }
}
?>
