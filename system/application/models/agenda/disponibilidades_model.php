...
///////////////////////////////////////////////////////////////////////////////
    function listado_disponibilidades()
    {
        ...
        $this->db->JOIN('core_medico b',' a.id_tercero = b.id_tercero');
        $this->db->JOIN('core_especialidad c','b.id_especialidad= c.id_especialidad');
        $this->db->JOIN('agenda_disponibilidades d','d.id_core_medico = b.id_medico');
        return $this->db->get()->result_array();
    }
    function disponbilidades_medico($id)
    {
        ...
        $this->db->FROM('agenda_detalle_disponbilidades a');
    ...
    {
        $this->db->DELETE('agenda_disponibilidades',array('id_core_medico'=>$id_medico));
        $this->db->INSERT('agenda_disponibilidades',array('id_core_medico'=>$id_medico,
                                                          'total_horas_mes'=>$horas,
                                                          'estado'=>$horas==0?0:1));
    }
    function eliminar_disponibilidad($id_disponibilidad)
    {
        $this->db->DELETE('agenda_detalle_disponbilidades',array('id_detalle_disponbilidad'=>$id_disponibilidad));
    }
    function buscar_disponibilidad($id_medico,$dia, $hora_inicio, $hora_final)
    {
        return $this->db->query("SELECT a.id_detalle_disponbilidad  
                                 FROM agenda_detalle_disponbilidades a
    ...
    {
         $this->db->INSERT('agenda_detalle_disponbilidades',array('id_disponbilidad'=>$id_medico,
...
///////////////////////////////////////////////////////////////////////////////
    function lista_medicos_agenda()
    {
	   ...
	   ct.segundo_apellido, ce.descripcion especialidad, cm.id_medico");
        ...
        $this->db->JOIN('agenda_disponibilidades ad','cm.id_medico = ad.id_core_medico');
