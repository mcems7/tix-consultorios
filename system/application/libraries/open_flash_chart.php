...
{
	include_once 'OFC/JSON.php';
}

include_once 'OFC/json_format.php';

// ofc classes
include_once 'OFC/ofc_title.php';
include_once 'OFC/ofc_y_axis_base.php';
include_once 'OFC/ofc_y_axis.php';
include_once 'OFC/ofc_y_axis_right.php';
include_once 'OFC/ofc_y_axis_labels.php';
include_once 'OFC/ofc_y_axis_label.php';
include_once 'OFC/ofc_x_axis.php';


include_once 'OFC/ofc_pie.php';
include_once 'OFC/ofc_bar_glass.php';
include_once 'OFC/ofc_bar_filled.php';
include_once 'OFC/ofc_bar_stack.php';
include_once 'OFC/ofc_hbar.php';
include_once 'OFC/ofc_line_base.php';
include_once 'OFC/ofc_line.php';
include_once 'OFC/ofc_candle.php';
include_once 'OFC/ofc_area_base.php';
include_once 'OFC/ofc_tags.php';
include_once 'OFC/ofc_arrow.php';

include_once 'OFC/ofc_x_legend.php';
include_once 'OFC/ofc_y_legend.php';
include_once 'OFC/ofc_bar_sketch.php';
include_once 'OFC/ofc_scatter.php';
include_once 'OFC/ofc_scatter_line.php';
include_once 'OFC/ofc_x_axis_labels.php';
include_once 'OFC/ofc_x_axis_label.php';
include_once 'OFC/ofc_tooltip.php';
include_once 'OFC/ofc_shape.php';
include_once 'OFC/ofc_radar_axis.php';
include_once 'OFC/ofc_radar_axis_labels.php';
include_once 'OFC/ofc_radar_spoke_labels.php';
include_once 'OFC/ofc_line_style.php';

include_once 'OFC/dot_base.php';
include_once 'OFC/ofc_menu.php';
