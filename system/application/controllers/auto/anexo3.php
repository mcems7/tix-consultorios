...
///////////////////////////////////////////////////////////////////
	function anexo3Mail($id_anexo)
	{
		...
		if(count($email) == 0)
		{
			...
			$this->email->from('cerca_anexo3@hospitalquindio.gov.co','Hospital Departamental Universitario del Quindío San Juan de Dios');
...
///////////////////////////////////////////////////////////////////
	function anexo3MailEnte($id_anexo)
	{
		$d['anexo'] = $this -> autorizaciones_model ->obtenerAnexo3($id_anexo);
		$d['envios'] = $this -> autorizaciones_model -> obtenerEnviosAnexo3($id_anexo);
		//----------------------------------------------------------
    	...
    	// Entidad territorial
		$correos = $this -> autorizaciones_model -> obtenerCorreosEntidad('13');
