...
<tr><th colspan="2">Registro de la Orden </th></tr>
<tr>
<td>
<div id="con_ord">
...
<tr>
    ...
    <td class="campo_centro">Registro No</td>
...
<td><?=$d['cups'];?></td>
<td><?=$d['registro_numero'];?></td>



<?php 
if($d['interpretada'] == 'NO'){ ?>
<td class="opcion"><a href="<?=site_url('lab/hce_laboratorio/OrdenInterpretar/'.$d['id_ordenes'].'/'.$d['registro_numero'].'/'.$id_atencion)?>"><strong>Interpretar</strong></a></td>
<?php } 
else { ?>
<td class="opcion"><a href="<?=site_url('lab/hce_laboratorio/OrdenConsultar/'.$d['id_ordenes'].'/'.$d['registro_numero'].'/'.$id_atencion)?>"><strong>Consultar</strong></a></td>
</tr> <?php } ?> 
<?php
	}
		echo "</table>";
