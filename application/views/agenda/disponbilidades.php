...
$attributes = array('id'=> 'formulario','name'=> 'formulario',
                    'method' => 'post','onsubmit'=> 'return agregar_disponibilidad()');
echo form_open('agenda/disponibilidades/',$attributes);
?>
...
$attributes = array('id'=> 'formulario','name'=> 'formulario_eliminiar_disponbilidad',
                    'method' => 'post','onsubmit'=> 'return eliminar_disponibilidad()');
