...
<?php
if($d['id_servicio'] == 16 || $d['id_servicio'] == 17 || $d['id_servicio'] == 18)
{
echo anchor('urg/observacion/main/'.$d['id_atencion'],'Gesti&oacute;n de la atenci&oacute;n');
}else{
echo anchor('urg/gestion_atencion/main/'.$d['id_atencion'],'Gesti&oacute;n de la atenci&oacute;n');
}
?></strong>
</td>
<?php
