...
<img src="<?=base_url()?>resources/img/triangulo.png"/></a></span>
 ...
 <tr>
  <th colspan="2">Facturas generadas de la Atencion</th></tr>
<tr>
<tr>
  <td colspan="2">
...
if ($facturas_atencion !=0)
{	
	
foreach($facturas_atencion as $d)
	{
	$d['det_contrato'] = $this->factura_model->obtenerDatosContrato($d['id_contrato']);
...
<td><?=$d['fecha']?></td>
<td><strong><?=anchor('/fac/factura/consultarFactura/'.$atencion['id_atencion'].'/'.$d['id_contrato'],$d['factura_detalle']." ".$d['factura_numero']);?></strong></td>
