...
function consultaMedi(atc)
{
	...
	var obj = "div_"+atc;
	var var_url = '<?=site_url()?>/far/far_hospi/historiaMedicamento/'+id+'/'+atc;
...
<tr><td class="campo">Peso:</td><td><?php $peso=$this->hospi_model->obtenerNotaInicial($atencion['id_atencion']); echo $peso['peso']; ?></td>
...
<tr><td class="campo">Cama:</td><td><?php $cama=$this->farmacia_model->obtenerCamaFarmaciaHospi($atencion['id_atencion']); echo $cama['numero_cama']; ?></td></tr>
<tr><td class="campo">Diagnostico(s):</td><td><?php $diagnostico=$this->farmacia_model->obtenerDxFarmaciaHospi($atencion['id_atencion']); 
