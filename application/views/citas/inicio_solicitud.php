...
<td id="nombre_municipio"><input size="60" type="text"  name="nombre_municipio" value="" 
onkeyup="ajax_showOptions(this,'citas/solicitar_cita/municipios/'+$('nombre_departamento_hidden').value,event)" AUTOCOMPLETE="off">
<input type="hidden" id="nombre_municipio_hidden" name="nombre_municipio_hidden"></td></tr>
<tr>
...
<td><select name="id_entidad_remitente" id="id_entidad_remitente">
...
<td><?=form_textarea(array('name' => 'revision_sistemas',
								...
								'cols'=> '50'))?></td></tr>
<tr>
<td class='campo'>Examen Físico(Aspectos Positivios):</td>
...
<tr>
<td class='campo'>Paraclínicos Realizados:</td>
<td><?=form_textarea(array('name' => 'paraclinicos_realizados',
								'id'=> 'paraclinicos_realizados',
								'rows' => '5',
								'cols'=> '50'))?></td></tr>
<tr>
<td class='campo'>Tratamientos Realizados:</td>
